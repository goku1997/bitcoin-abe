#!/usr/bin/python
#
# This code is extracted from the pysha2 package:
...
def hash_file(file_path):
    ...
    try:
        ...
        def chunker():
            return f.read(128 * checksum.block_size)
...
class sha256(object):
    ...
    _h = (0x88888888L, 0x88888888L, 0x88888888L, 0x88888888L,
          0x88888888L, 0x88888888L, 0x88888888L, 0x88888888L)
    _output_size = 8
